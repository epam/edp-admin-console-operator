...
func (in *AdminConsoleSpec) DeepCopyInto(out *AdminConsoleSpec) {
	*out = *in
	...
	out.DbSettings = in.DbSettings
	out.ExternalConfiguration = in.ExternalConfiguration
	return
}
...
func (in *ExternalConfiguration) DeepCopyInto(out *ExternalConfiguration) {
	*out = *in
	...
	out.KeycloakUser = in.KeycloakUser
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalConfigurationItem) DeepCopyInto(out *ExternalConfigurationItem) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalConfigurationItem.
func (in *ExternalConfigurationItem) DeepCopy() *ExternalConfigurationItem {
	if in == nil {
		return nil
	}
	out := new(ExternalConfigurationItem)
	in.DeepCopyInto(out)
	return out
}
