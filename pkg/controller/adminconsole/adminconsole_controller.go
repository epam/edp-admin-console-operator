...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAdminConsole{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileAdminConsole) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set AdminConsole instance as the owner and controller
...
func newPodForCR(cr *edpv1alpha1.AdminConsole) *corev1.Pod {
