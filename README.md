...
```bash
helm install admin-console-operator --namespace <edp_cicd_project> --set name=admin-console-operator --set namespace=<edp_cicd_project> --set platform=<platform_type> --set image.name=epamedp/admin-console-operator --set image.version=<operator_version> --set dnsWildcard=<dns_wildcard> deploy-templates
```
